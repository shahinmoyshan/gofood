...
<div class="gf_custom_meta_box_field">
	...
	<input type="text" id="product_price" name="product_price" value="<?php echo esc_attr( $price ); ?>" size="25" />
</div>

<div class="gf_custom_meta_box_field">
	<label for="product_discount_price"><?php echo esc_html__( 'Discounted Price:', 'gofood' ); ?></label>
	<input type="text" id="product_discount_price" name="product_discount_price" value="<?php echo esc_attr( $discount ); ?>" size="25" />
</div>

<div class="gf_custom_meta_box_field">
	<label for="product_stock_quantity"><?php echo esc_html__( 'Stock Quantity:', 'gofood' ); ?></label>
	<input type="number" id="product_stock_quantity" name="product_stock_quantity" value="<?php echo esc_attr( $stock ); ?>" min="0" step="1" />
</div>
