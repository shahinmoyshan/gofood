...
<div class="wrap">
	...
	<a href="<?php echo esc_html( add_query_arg( array( 'action' => 'table' ) ) ); ?>" class="page-title-action"><?php echo esc_html__( 'Data List', 'gofood' ); ?></a>
			...
			<div id="post-body-content">
				...
				<div class="meta-box-sortables ui-sortable cps_form-middle cps_unbordared cps_wide-lg">
					...
					<table class="wp-list-table widefat fixed striped ">
						...
						<?php else : ?>
							<tr>
								<td colspan="2"><?php esc_html__( 'Record not found', 'gofood' ); ?></td>
							</tr>
						<?php endif; ?>
					</table>
