			...
			<div id="post-body-content">
				...
				<div class="cps_form-middle cps_form">
					...
					<form method="post">
						...
						<?php wp_nonce_field( 'gofood_bread', 'gofood_bread_nonce', false ); ?>
						...
						<div class="cps_center cps_mt-5">
							<button type="submit" class="button button-primary"><?php echo isset( $edit_data[ $table->get_primary_key() ] ) ? esc_html__( 'Update', 'gofood' ) : esc_html__( 'Create', 'gofood' ); ?></button>
						</div>
